...
export default function Footer() {
  ...
  // Array de enlaces principales para el footer (con sus IDs)
  const footerLinks = [
    { label: t('nav.global'), href: '#global-capabilities' },
    { label: t('nav.local'), href: '#local-capabilities' },
    { label: t('nav.stories'), href: '#success-stories' },
    { label: t('nav.framework'), href: '#framework' },
    { label: t('nav.requestDiagnostic'), href: '#contact' } // Ajusta si tienes un ID para contacto
  ];
  ...
  const legalLinks = [
    ...
    { label: t('footer.manageCookies'), href: '#manage-cookies' }
  ];
  ...
  return (
    ...
    >
      ...
      {/* Patrón de Red / Cuadrícula técnica institucional */}
      <div 
      ...
      {/* Capas de Fulgores Estáticos Ambientales */}
      ...
      <div className="relative max-w-7xl mx-auto z-10 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 items-center pb-12 border-b border-white/10">
          ...
          {/* COLUMNA 3: Redes Sociales (sin cambios, pero puedes traducir los titles si quieres) */}
          <div className="md:col-span-3 flex items-center md:justify-end space-x-4">
            <a href="https://www.facebook.com/people/WeProm-Europe/61586910983969/#" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white text-[#0F1A30] flex items-center justify-center hover:bg-blue-400 hover:text-white transition-all duration-300 shadow-md hover:-translate-y-1 hover:shadow-blue-500/20">
              <svg className="w-5 h-5 fill-currentColor" viewBox="0 0 24 24">
                <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c4.56-.93 8-4.96 8-9.8z"/>
              </svg>
            </a>
            <a href="https://www.instagram.com/wepromeurope/" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white text-[#0F1A30] flex items-center justify-center hover:bg-blue-400 hover:text-white transition-all duration-300 shadow-md hover:-translate-y-1 hover:shadow-blue-500/20">
              <svg className="w-5 h-5 fill-currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://www.linkedin.com/company/wepromeurope" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white text-[#0F1A30] flex items-center justify-center hover:bg-blue-400 hover:text-white transition-all duration-300 shadow-md hover:-translate-y-1 hover:shadow-blue-500/20">
              <svg className="w-5 h-5 fill-currentColor" viewBox="0 0 24 24">
